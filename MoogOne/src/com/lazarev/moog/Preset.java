 ...
 * Parameters and Values in the Preset. In order to write out a Preset in the correct
 ...
 * is required, but all of the Moog One Presets appear to be saved in the same one
 * 
 * @author Mike Lazarev
 *
 */
public class Preset {
	...
	/**
	 * This method expects to be called in order, as each line of a preset is read at a time.
